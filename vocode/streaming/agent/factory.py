...
from vocode.streaming.agent.chat_ollama_agent import ChatOllamaAgent
...
class AgentFactory:
    def create_agent(
        ...
        elif isinstance(agent_config, ChatOllamaAgentConfig):
            return ChatOllamaAgent(agent_config=agent_config, logger=logger)
        elif isinstance(agent_config, ChatGroqAgentConfig):
            return ChatGroqAgent(agent_config=agent_config, logger=logger)
